...
<sc version="201801" id="9" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="1772585475">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="T" defaultSignalSequence="3">
      <defaultDurations>
    ...
    <sg id="2" name="A" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
  ...
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="300000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
        <sg sg_id="1" signal_sequence="3">
          <cmds>
            <cmd display="3" begin="120000" />
            <cmd display="1" begin="165000" />
          </cmds>
          <fixedstates>
